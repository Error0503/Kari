...
<html lang="hu-HU" style="background-color: #004504">
	...
	<body>
		<div style="text-align:center; margin:auto; width:55vw; border: 2px solid red; border-radius: 5px; padding: 10px; background-color: #007307; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
